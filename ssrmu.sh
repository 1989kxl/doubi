...
Download_SSR(){
	cd "/usr/local"
	wget -N --no-check-certificate "https://github.com/1989kxl/shadowsocks/archive/manyuser.zip"
	...
	unzip "shadowsocks-manyuser.zip"
...
Install_Libsodium(){
	...
	if [[ ${release} == "centos" ]]; then
		...
		echo -e "${Info} 下载..."
		wget  --no-check-certificate -N "https://github.com/1989kxl/libsodium/releases/download/${Libsodiumr_ver}/libsodium-${Libsodiumr_ver}.tar.gz"
		echo -e "${Info} 解压..."
